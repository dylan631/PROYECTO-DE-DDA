...
public class Transacciones extends javax.swing.JPanel {
    ...
    public Transacciones() {
        initComponents();
        Eventos_graficos.decorar_tabla_estandar(tablaTransaccion,scrollTablaTransaccion );
    }
    ...
    private void initComponents() {
        ...
        tablaTransaccion.setRowHeight(35);
        tablaTransaccion.setShowHorizontalLines(false);
        tablaTransaccion.setShowVerticalLines(false);
        scrollTablaTransaccion.setViewportView(tablaTransaccion);

        add(scrollTablaTransaccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 830, 190));
